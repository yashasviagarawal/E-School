...
public class MathsTeachersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths_teachers);
    ...
    private void uploadeFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("Maths/"+title+".pdf");
