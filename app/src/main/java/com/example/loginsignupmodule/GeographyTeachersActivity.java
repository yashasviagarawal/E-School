...
public class GeographyTeachersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geography_teachers);
    ...
    private void viewAllFiles() {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Geography");
    ...
    private void uploadeFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("Geography/"+title+".pdf");
