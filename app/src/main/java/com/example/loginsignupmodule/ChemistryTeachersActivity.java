...
public class ChemistryTeachersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemistry_teachers);
    ...
    private void viewAllFiles() {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Chemistry");
    ...
    private void uploadeFile(Uri data) {
        ...
        StorageReference reference = storageReference.child("Chemistry/"+title+".pdf");
