...
public class LibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        physics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LibraryActivity.this,PhysicsActivity.class);
        ...
        biology.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to Biology Content",Toast.LENGTH_SHORT).show();
            }
        });
        chemistry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LibraryActivity.this,ChemistryActivity.class);
                startActivity(intent);
        ...
        maths.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LibraryActivity.this,MathsActivity.class);
                startActivity(intent);
        ...
        english.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LibraryActivity.this,EnglishActivity.class);
                startActivity(intent);
        ...
        hindi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to Hindi Content",Toast.LENGTH_SHORT).show();
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to History Content",Toast.LENGTH_SHORT).show();
            }
        });
        civics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to Civics Content",Toast.LENGTH_SHORT).show();
            }
        });
        geography.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to Geography Content",Toast.LENGTH_SHORT).show();
            }
        });
        economics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //startActivity(intent);
                Toast.makeText(LibraryActivity.this,"This will take u to Economics Content",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.chat_box_button )
        {
            ...
            //startActivity(intent);
            Toast.makeText(LibraryActivity.this,"this will take u to chat box",Toast.LENGTH_SHORT).show();
        }
